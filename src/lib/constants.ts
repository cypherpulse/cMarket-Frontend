...
// Network-specific contract deployments for decentralized marketplace
export const CONTRACTS = {
  ...
  [celoMainnet.id]: {
    // Mainnet contract addresses - update when marketplace contract is deployed to production
